...
package ir.muhammadzadeh.materialkurdishdatetimepicker.time;
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    private void setHour(int value, boolean announce) {
        ...
        String text = LanguageUtils.getKurdishNumbers(String.format(format, value));
    ...
    private void setMinute(int value) {
        ...
        CharSequence text = LanguageUtils.getKurdishNumbers(String.format(Locale.getDefault(), "%02d", value));
        Utils.tryAccessibilityAnnounce(mTimePicker, text);
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            mHourView.setText(LanguageUtils.getKurdishNumbers(hourStr));
            mHourSpaceView.setText(LanguageUtils.getKurdishNumbers(hourStr));
            mHourView.setTextColor(mUnselectedColor);
            mMinuteView.setText(LanguageUtils.getKurdishNumbers(minuteStr));
            mMinuteSpaceView.setText(LanguageUtils.getKurdishNumbers(minuteStr));
