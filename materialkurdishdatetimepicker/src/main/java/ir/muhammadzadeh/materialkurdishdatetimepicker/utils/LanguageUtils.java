...
public class LanguageUtils {
    ...
    public static String getKurdishNumbers(String string) {
    ...
    public static String[] getKurdishNumbers(String[] strings) {
        for (int i=0; i<strings.length; i++) {
            strings[i] = getKurdishNumbers(strings[i]);
        }
        return strings;
    }

    public static ArrayList<String> getKurdishNumbers(ArrayList<String> strings) {
        for (int i=0; i<strings.size(); i++) {
            strings.set(i, getKurdishNumbers(strings.get(i)));
        }
        return strings;
    }
