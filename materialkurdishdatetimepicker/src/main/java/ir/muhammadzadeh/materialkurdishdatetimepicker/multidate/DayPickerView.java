...
import ir.muhammadzadeh.materialkurdishdatetimepicker.multidate.MultiDatePickerDialog.OnDateChangedListener;
...
//        }
    ...
    public void onDateChanged() {
        KurdishCalendar persianCalendar = new KurdishCalendar(mController.getSelectedDays()
                .get(mController.getSelectedDays().size() - 1).getTimeInMillis());
        persianCalendar.setKurdishDate(mController.getSelectedYear()
                , persianCalendar.getKurdishMonth(), persianCalendar.getKurdishDay());
    ...
    private static String getMonthAndYearString(MonthAdapter.CalendarDay day) {
        KurdishCalendar mKurdishCalendar = new KurdishCalendar();
        mKurdishCalendar.setKurdishDate(day.year, day.month, day.day);

        String sbuf = "";
        sbuf += mKurdishCalendar.getKurdishMonthName();
        sbuf += " ";
        sbuf += mKurdishCalendar.getKurdishYear();
        return sbuf;
    }
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        Utils.tryAccessibilityAnnounce(this,
                LanguageUtils.getKurdishNumbers(getMonthAndYearString(day)));
